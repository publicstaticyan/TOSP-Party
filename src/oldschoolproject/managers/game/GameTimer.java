...
import oldschoolproject.utils.builders.MessageBuilder;
import oldschoolproject.utils.builders.MessageBuilder.MessageType;
...
public class GameTimer {
	...
	public GameTimer(Game game, int limitTime) {
	...
	public void startLobbyCoundown() {
		new BukkitRunnable() {
			...
			public void run() {
				...
				case -1:
					broadcastMessage(mb.setMessage("§aA festa começou! Bom jogo a todos!").setType(MessageType.GOOD).toString());
					startGameTimer();
